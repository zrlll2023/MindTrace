...
当前正式版本为 [`v0.3.0`](https://github.com/zrlll2023/MindTrace/releases/tag/v0.3.0)。主要更新包括：

- 打通手动记录、AI 快速记录与知识库的收录流程。
- 重构 AI 对话导入：知识库保存完整会话，时间线保存摘要。
- 新增“我的”页面、个人资料与趋势查看。
- 增加安全的数据目录迁移。
- 加入语义搜索、长文本分块、混合检索和 LLM 精排。
- 完成浅色/深色界面、自定义标题栏和可排序导航。
- 建立标准 GitHub Release 发布链和应用内版本更新。

完整内容请查看 [v0.3.0 Release Notes](https://github.com/zrlll2023/MindTrace/releases/tag/v0.3.0)。
